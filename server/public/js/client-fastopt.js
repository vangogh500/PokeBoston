...
/** @constructor */
function $c_Lcom_pokeboston_client_Client$() {
  $c_O.call(this);
...
$c_Lcom_pokeboston_client_Client$.prototype = new $h_O();
$c_Lcom_pokeboston_client_Client$.prototype.constructor = $c_Lcom_pokeboston_client_Client$;
/** @constructor */
function $h_Lcom_pokeboston_client_Client$() {
  /*<skip>*/
}
$h_Lcom_pokeboston_client_Client$.prototype = $c_Lcom_pokeboston_client_Client$.prototype;
$c_Lcom_pokeboston_client_Client$.prototype.init___ = (function() {
  $n_Lcom_pokeboston_client_Client$ = this;
  $f_s_App__$$init$__V(this);
  var body = new $c_Lcom_pokeboston_client_Client$delayedInit$body().init___Lcom_pokeboston_client_Client$(this);
  this.scala$App$$initCode$1.$$plus$eq__O__scm_ListBuffer(body);
  return this
});
$c_Lcom_pokeboston_client_Client$.prototype.main__AT__V = (function(args) {
  $f_s_App__main__AT__V(this, args)
});
$c_Lcom_pokeboston_client_Client$.prototype.delayedEndpoint$com$pokeboston$client$Client$1__V = (function() {
  var jsx$2 = $m_Ljapgolly_scalajs_react_package$().ScalaComponent$1;
  $m_Ljapgolly_scalajs_react_vdom_html$und$less$up$();
  var jsx$1 = $m_Ljapgolly_scalajs_react_vdom_HtmlTagOf$();
  $m_Ljapgolly_scalajs_react_vdom_html$und$less$up$();
  var array = [($m_Ljapgolly_scalajs_react_vdom_html$und$less$up$(), $m_Ljapgolly_scalajs_react_vdom_VdomNode$(), new $c_Ljapgolly_scalajs_react_vdom_VdomNode().init___sjs_js_$bar("PokeBoston"))];
  var a = jsx$1.apply$extension__T__sc_Seq__Ljapgolly_scalajs_react_vdom_TagOf("h1", new $c_sjs_js_WrappedArray().init___sjs_js_Array(array));
  this.PlaceHolder$1 = jsx$2.$static__T__Ljapgolly_scalajs_react_vdom_VdomNode__Ljapgolly_scalajs_react_component_JsBaseComponentTemplate$ComponentWithRoot("PlaceHolder", a.render__Ljapgolly_scalajs_react_vdom_VdomElement());
  var c = this.PlaceHolder$1;
  ...
  $f_Ljapgolly_scalajs_react_component_Generic$UnmountedSimple__renderIntoDOM__sjs_js_$bar__F0__O(qual$1, a$1, x$2)
});
var $d_Lcom_pokeboston_client_Client$ = new $TypeData().initClass({
  Lcom_pokeboston_client_Client$: 0
}, false, "com.pokeboston.client.Client$", {
  Lcom_pokeboston_client_Client$: 1,
  O: 1,
  s_App: 1,
  s_DelayedInit: 1
});
$c_Lcom_pokeboston_client_Client$.prototype.$classData = $d_Lcom_pokeboston_client_Client$;
var $n_Lcom_pokeboston_client_Client$ = (void 0);
function $m_Lcom_pokeboston_client_Client$() {
  if ((!$n_Lcom_pokeboston_client_Client$)) {
    $n_Lcom_pokeboston_client_Client$ = new $c_Lcom_pokeboston_client_Client$().init___()
  };
  return $n_Lcom_pokeboston_client_Client$
}
/** @constructor */
function $c_Lcom_pokeboston_client_Client$delayedInit$body() {
  $c_sr_AbstractFunction0.call(this);
  this.$$outer$2 = null
}
$c_Lcom_pokeboston_client_Client$delayedInit$body.prototype = new $h_sr_AbstractFunction0();
$c_Lcom_pokeboston_client_Client$delayedInit$body.prototype.constructor = $c_Lcom_pokeboston_client_Client$delayedInit$body;
/** @constructor */
function $h_Lcom_pokeboston_client_Client$delayedInit$body() {
  /*<skip>*/
}
$h_Lcom_pokeboston_client_Client$delayedInit$body.prototype = $c_Lcom_pokeboston_client_Client$delayedInit$body.prototype;
$c_Lcom_pokeboston_client_Client$delayedInit$body.prototype.init___Lcom_pokeboston_client_Client$ = (function($$outer) {
  if (($$outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.$$outer$2 = $$outer
...
$c_Lcom_pokeboston_client_Client$delayedInit$body.prototype.apply__O = (function() {
  this.$$outer$2.delayedEndpoint$com$pokeboston$client$Client$1__V()
});
var $d_Lcom_pokeboston_client_Client$delayedInit$body = new $TypeData().initClass({
  Lcom_pokeboston_client_Client$delayedInit$body: 0
}, false, "com.pokeboston.client.Client$delayedInit$body", {
  Lcom_pokeboston_client_Client$delayedInit$body: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1
});
$c_Lcom_pokeboston_client_Client$delayedInit$body.prototype.$classData = $d_Lcom_pokeboston_client_Client$delayedInit$body;
/** @constructor */
    ...
    return (function(n$2) {
      ...
      return new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($this$1, n$1) {
        return (function(x$16$2) {
          ...
          var x$18 = x$16.componentDidMount$1;
          var x$19 = x$16.componentDidUpdate$1;
          var x$20 = x$16.componentWillMount$1;
          var x$21 = x$16.componentWillReceiveProps$1;
          var x$22 = x$16.componentWillUnmount$1;
          var x$23 = x$16.componentWillUpdate$1;
          var x$24 = x$16.componentDidCatch$1;
          return new $c_Ljapgolly_scalajs_react_component_builder_Lifecycle().init___s_Option__s_Option__s_Option__s_Option__s_Option__s_Option__s_Option__s_Option(x$18, x$19, x$20, x$21, x$22, x$23, n$1, x$24)
        })
      })(this$2, n))
    })
  })(this));
...
$c_Ljapgolly_scalajs_react_component_builder_Lifecycle$ComponentDidCatch.prototype.toString__T = (function() {
  return $m_Ljapgolly_scalajs_react_component_builder_Lifecycle$().japgolly$scalajs$react$component$builder$Lifecycle$$wrapTostring__T__T(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["ComponentDidCatch(", ")"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([this.error$1])))
});
...
$m_Lcom_pokeboston_client_Client$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
